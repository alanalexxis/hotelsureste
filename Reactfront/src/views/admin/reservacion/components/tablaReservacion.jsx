...
const TablaReservaciones = (props) => {
  ...
  const deleteReservacion = async (idreservacions) => {
    await axios.delete(`${URI}${idreservacions}`);
    setOpen(false);
      ...
      <Card extra={"w-full pb-10 p-4 h-full"} style={{ marginTop: "50px" }}>
        ...
        <div className="mt-8 overflow-x-scroll ">
          <table className="w-full">
            ...
            <tbody>
              {currentProducts.map((reservacion, index) => (
                <tr>
                  ...
                  <td className="flex items-center">
                    ...
                    {open && deleteTargetId === reservacion.idreservacions && (
                                      ...
                                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                          <p className="text-sm text-gray-500 dark:text-gray-300">
                                            ...
                                            esta reservacion? Todos sus datos
